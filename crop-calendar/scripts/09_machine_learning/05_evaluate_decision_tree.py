...
Script  : 05_evaluate_decision_tree.py
Purpose : Evaluate Decision Tree Regression Model
============================================================
"""
...
plt.savefig(
    os.path.join(
        OUTPUT_FOLDER,
        "decision_tree_residual_plot.png"
    )
)
...
plt.savefig(
    os.path.join(
        OUTPUT_FOLDER,
        "decision_tree_error_distribution.png"
    )
)
...
plt.savefig(
    os.path.join(
        OUTPUT_FOLDER,
        "decision_tree_feature_importance_bar.png"
    )
)
...
report = os.path.join(
    OUTPUT_FOLDER,
    "decision_tree_evaluation_report.txt"
)
...
print("- Decision Tree Actual vs Predicted Plot")

print("- Decision Tree Residual Plot")

print("- Decision Tree Error Distribution")

print("- Decision Tree Feature Importance Plot")
